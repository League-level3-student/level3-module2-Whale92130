...
class _03_SearchTest {
    ...
    public void testBinarySearch() {
    	...
    	assertEquals(7, _02_BinarySearch.binarySearch(ints, 0, 7, 999999));
    	assertEquals(0, _02_BinarySearch.binarySearch(ints, 0, 7, 1));
    	assertEquals(-1, _02_BinarySearch.binarySearch(ints, 0, 7, 55));
    }
}
